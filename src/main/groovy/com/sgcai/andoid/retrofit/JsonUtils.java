...
public class JsonUtils {
     ...
     */
    public static void parseJson2Java(String jsonStr, String javaFile) {
        // 解析获取整个json结构集合
        ...
        // 将生成的内容写入到文件中去
        FileUtils.writeString2File(javaBeanStr, new File(javaFile));
    }
    ...
    public static Map<String, Object> fromJsonToMap(String json) {
        ...
        Map<String, Object> map = gson.fromJson(json, type.getType());
        return map;
    }

    public static <T> T fromJsonBean(String json, Class<T> clazz) {
        T t = null;
        Gson gson = new Gson();
